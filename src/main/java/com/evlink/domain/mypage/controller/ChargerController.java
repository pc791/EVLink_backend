...
import com.evlink.domain.mypage.service.ChargerService;
import com.evlink.domain.mypage.vo.ChargerVO;

import jakarta.servlet.http.HttpSession;

@RestController
@RequestMapping("/mypage/charger")
public class ChargerController {
	...
	// 개인 충전소 조회
	@GetMapping("/{userId}")
	public ChargerVO getUserCommInfo(HttpSession session, @PathVariable("userId") long userId) {
		return chargerService.getCharger(userId);
	}
